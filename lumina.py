...
from local_speech_to_text import LocalSpeechToText as SpeechToText
from local_storage_service import LocalStorageService as BlobStorageService
...
class MeetingSession:
    ...
    def process_recording(self, audio_path: Path):
        ...
        try:
            ...
            print("Transcribing and analyzing with local Whisper...")
            stt = SpeechToText()
            stt.transcribe(str(audio_path), meeting_id=self.meeting_id)
